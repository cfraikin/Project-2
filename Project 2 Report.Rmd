...
p1<-ggplot(data_long, aes(x=Dates, y=SumCases, color=dataset)) + 
  scale_color_discrete(name= "California Total",breaks=c("Confirmed", "Deaths")) +
...
p2<-ggplot(data_long, aes(x=Dates, y=SumCases, color=Admin2)) + 
  scale_color_discrete(name="Top Confirmed Cities", breaks=c("Los Angeles", "Riverside", "San Diego")) +
